          ...
          <div className="h-full rounded-xl overflow-hidden shadow-2xl flex ring-1 ring-border w-full">
            {colors.map((color, idx) => (
              <button
                ...
                className="cursor-pointer flex-1 min-w-0  h-full flex flex-col items-center justify-end pb-4 group relative transition-[flex] hover:flex-2 duration-500 ease-[cubic-bezier(0.25,1,0.5,1)]"
              >
